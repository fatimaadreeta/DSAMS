...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <h1 class="text-center p-3">New event Proposal submitted successfully</h1>
            <div class="mt-3 m-3 p-3 text-center">
                <a class="invert button" href="dashboard/proposals.php">Check Proposal List</a>
            </div>
        </main>
    </body>
</html>
