                    ...
                    <?php
                       ...
                       <form action="publishProcess.php" class="d-flex flex-column col-12" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="startDate" class="form-control" value="'. date("Y-m-d", strtotime($result['startDate'])).'">
                            </div>
                             <div class="form-group">
                                <label for="Time" name="Time" >Time: </label>
                                <input type="text" name="Time" class="form-control" Placeholder="Enter your event time here">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="posterImg"> Poster Image </label> 
