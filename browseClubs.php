        ...
        <div  class="container">
            ...
            <div  class="row">
                <div class="col-12 col-lg-2">
                    <form class="form" method="GET" action="browseClubs.php">
                        <div class="row">
                            <div class="col g-0">
                ...
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <?php
                            ...
                            $sql = "SELECT * FROM club WHERE clubName LIKE '%".$search."%'";
                            unset($search);
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="row">
                        <?php
                            include_once "database.php";
                            $sql1 = "SELECT * FROM activity WHERE activityTag LIKE '%EVENT%'";
                            ...
                            if(!isset($result)){
                                ...
                                foreach($eventsArray as $index => $arrayRow){
